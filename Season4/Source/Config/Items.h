...
public:
	CItem();
	void Clear();
	void Convert(int Index,BYTE Option1,BYTE Option2,BYTE Option3,BYTE Attribute2,BYTE SetOption,BYTE ItemEffectEx,BYTE DbVersion);
	void Value();
	bool IsSocketItem();
	static bool IsClass(char Job,int ChangeUp);
	bool IsItem();
  ...
  /*<thisrel this+0xb4>*/ /*|0x5|*/ unsigned char m_ItemSocket[5];
